...
function exec(message, args) {
    if (!args.toSet) return message.channel.sendEmbed(this.client.util.embed().setAuthor(`${config.prefix}status`).setDescription("Changes the bots status. Available statuses are **online, dnd, idle, and invisible**").setColor(14493733));
